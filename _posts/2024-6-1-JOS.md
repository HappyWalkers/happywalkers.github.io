...
thumbnail: /assets/images/thumbnails/JOS.jpg
---
...
> The `ns.png` network-server diagram referenced by the original notes was not included in the old site repository.
...
> The `transmit_descriptor_ring_structure.png` diagram referenced by the original notes was not included in the old site repository.
...
> The `receive_descriptor_ring_structure.png` diagram referenced by the original notes was not included in the old site repository.
